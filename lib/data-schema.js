...
export const schemas = {
  ...
  "references.json": {
    ...
    fields: {
      client: str,
      sector: str,
      /* Verweise auf services.json — die Karte zeigt shortTitle des
         jeweiligen Eintrags. Bewusst IDs statt ausgeschriebener Namen:
         so kann die Referenzkarte nicht von den Leistungen abweichen
         und die Übersetzung ergibt sich von selbst. */
      services: {
        type: "array",
        required: true,
        ofString: true
      },
      /* Beides erst, wenn der Inhaber belegbaren Text hat. Fehlt es,
         rendert die Karte den Absatz gar nicht — lieber nichts sagen
         als eine leere Behauptung. */
      summary: strOpt,
      result: strOpt,
      url: strOpt
    }
